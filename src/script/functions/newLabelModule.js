...
const newLabelModule = () =>{
    ...
    const hideLabelForm = () => {
        formHelber.hideForm(".add-label-overlay");
    };
    const showLabelForm = () => {
        formHelber.showForm(".add-label-overlay");
    };
    return {clearAddLabel, newLabelName, showLabelForm, hideLabelForm, addNewLabelNode};
};
export {newLabelModule}