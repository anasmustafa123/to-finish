...
const newTaskModule = () => {
    ...
    const hideTaskForm = () => {
        formHelber.hideForm(".add-task-overlay");
    };
    const showTaskForm = () => {
        formHelber.showForm(".add-task-overlay");
    };
    return {clearAddTask, addTaskData, hideTaskForm, showTaskForm, selectDefaultDate, addNewTaskNode,selectDefaultPiority, getCheckedLabelsCount};
};
export {newTaskModule}